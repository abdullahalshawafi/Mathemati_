$(document).ready(() => {
    ...
    for (let i = 0; i < 72; i++) {
        if (i < 10)
            $('body').append(`<div id="preload-image-${i}" style="background-image: url('static/HoverAnimations/SRI/SRI000${i}.png');"</div>`)
        else
            $('body').append(`<div id="preload-image-${i}" style="background-image: url('static/HoverAnimations/SRI/SRI00${i}.png');"</div>`)
    }
    for (let i = 0; i < 72; i++) {
        if (i < 10)
