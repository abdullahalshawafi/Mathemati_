...
def SurfaceFitting():
    if request.method == 'POST':
        ...
        if LHS and not Sr == '':
            #print(LHS, Sr)
            return render_template('SurfaceFitting.html', url="mRjVy0MSUI0", title='Surface Fitting', css="SurfaceFitting.css", wing="CF Header.png", logo="Logo.svg", results=RHS, Error=Sr)
        elif not xdata:
